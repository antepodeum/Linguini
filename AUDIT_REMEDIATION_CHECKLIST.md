...
- [-] #14 — Execute normative documentation as conformance fixtures. Standalone Linguini syntax
  and TOML config fences are enforced; generated TypeScript/Svelte runtime fixtures remain.
...
- [-] #369 — Make documentation and examples an executable conformance suite. The root full
  profile enforces Linguini syntax and TOML config fences and explicitly registers fragments.
...
- [-] DOC-C1 — Register every normative code block as a fixture. Linguini syntax and TOML blocks
  are registered; shell, TypeScript, HTML, and Svelte blocks remain.
...
- [-] P3-3 — Full documentation-to-runtime conformance corpus. Linguini syntax and canonical
  configuration fences execute; packaged typecheck and runtime stages remain.
