...
function pluralPt(value: number | string): string {
...
const __lgl_form_6D61696E2E4672756974 = {
  apple: { Gender: "neuter", emoji: "🍎", nom: (value: number | string) => selectBranch(pluralPt(value), { one: "maçã", _: "maçãs" }) },
  pear: { Gender: "female", emoji: "🍐", nom: (value: number | string) => selectBranch(pluralPt(value), { one: "pera", _: "peras" }) },
  orange: { Gender: "male", emoji: "🍊", nom: (value: number | string) => selectBranch(pluralPt(value), { one: "laranja", _: "laranjas" }) },
} as const;
...
export const main = {
  ...
  hero: {
    ...
    intro: "Linguini transforma ficheiros de localização tipados em código que qualquer app pode usar. Mensagens, gramática, formatadores, fallback de locales e rotas web são verificados no build.",
    trait_typed: "Tipado",
  ...
  playground: {
    ...
    currency_format: (amount: __lgl_name_6D61696E2E4D6F6E6579) => "Formato de moeda: " + String(formatCurrency(amount, { code: "EUR" })),
