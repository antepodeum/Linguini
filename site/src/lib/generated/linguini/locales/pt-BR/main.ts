...
function pluralPtBr(value: number | bigint | string): string {
...
const __lgl_form_6D61696E2E4672756974 = {
  apple: { Gender: "neuter", emoji: "🍎", nom: (value: number | bigint | string) => selectBranch(pluralPtBr(value), { one: "maçã", _: "maçãs" }) },
  pear: { Gender: "female", emoji: "🍐", nom: (value: number | bigint | string) => selectBranch(pluralPtBr(value), { one: "pera", _: "peras" }) },
  orange: { Gender: "male", emoji: "🍊", nom: (value: number | bigint | string) => selectBranch(pluralPtBr(value), { one: "laranja", _: "laranjas" }) },
} as const;
...
function __lgl_name_6D61696E2E53697A6541646A(__lgl_p0: __lgl_name_6D61696E2E53697A65, __lgl_p1: number | bigint | string, __lgl_p2: __lgl_name_6D61696E2E47656E646572): string {
  return selectBranch(String(__lgl_p0), { small: (): string => selectBranch(pluralPtBr(__lgl_p1), { one: (): string => selectBranch(String(__lgl_p2), { male: (): string => "pequeno", female: (): string => "pequena", neuter: (): string => "pequeno", _: (): string => "pequeno" })(), _: (): string => selectBranch(String(__lgl_p2), { male: (): string => "pequenos", female: (): string => "pequenas", neuter: (): string => "pequenos", _: (): string => "pequenos" })() })(), big: (): string => selectBranch(pluralPtBr(__lgl_p1), { one: (): string => selectBranch(String(__lgl_p2), { male: (): string => "grande", female: (): string => "grande", neuter: (): string => "grande", _: (): string => "grande" })(), _: (): string => selectBranch(String(__lgl_p2), { male: (): string => "grandes", female: (): string => "grandes", neuter: (): string => "grandes", _: (): string => "grandes" })() })(), _: (): string => "normais" })();
}
...
function __lgl_name_6D61696E2E44656C697665726564(__lgl_p0: number | bigint | string, __lgl_p1: __lgl_name_6D61696E2E47656E646572): string {
  return selectBranch(pluralPtBr(__lgl_p0), { one: (): string => selectBranch(String(__lgl_p1), { _: (): string => "Entregue" })(), _: (): string => "Entregues" })();
}

export const main = {
  codegen: {
    kicker: "Geração de código",
    title: "Um schema, saída TypeScript tipada",
  ...
  hero: {
    ...
    intro: "O Linguini transforma arquivos de locale vinculados ao schema em código gerado tipado. Antes da geração, check/build informam implementações ausentes e validam usos compatíveis de formatadores, chamadas de locale e ramos de dispatch que o analisador consegue resolver.",
    trait_typed: "Tipado",
  ...
  playground: {
    ...
    currency_format: (amount: __lgl_name_6D61696E2E4D6F6E6579) => "Formato de moeda: " + String(formatCurrency(amount, 2, 0, { code: "BRL" })),
