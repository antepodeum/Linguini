...
const __lgl_form_6D61696E2E4672756974 = {
  apple: { Gender: "neuter", emoji: "🍎", nom: (value: number | bigint | string) => selectBranch(pluralRu(value), { one: "яблоко", few: "яблока", _: "яблок" }) },
  pear: { Gender: "female", emoji: "🍐", nom: (value: number | bigint | string) => selectBranch(pluralRu(value), { one: "груша", few: "груши", _: "груш" }) },
  orange: { Gender: "male", emoji: "🍊", nom: (value: number | bigint | string) => selectBranch(pluralRu(value), { one: "апельсин", few: "апельсина", _: "апельсинов" }) },
} as const;

function __lgl_name_6D61696E2E53697A65576F7264(__lgl_p0: __lgl_name_6D61696E2E53697A65): string {
  return selectBranch(String(__lgl_p0), { small: (): string => "маленький", big: (): string => "большой", _: (): string => "обычный" })();
}
...
function __lgl_name_6D61696E2E53697A6541646A(__lgl_p0: __lgl_name_6D61696E2E53697A65, __lgl_p1: number | bigint | string, __lgl_p2: __lgl_name_6D61696E2E47656E646572): string {
  return selectBranch(String(__lgl_p0), { small: (): string => selectBranch(pluralRu(__lgl_p1), { one: (): string => selectBranch(String(__lgl_p2), { male: (): string => "маленький", female: (): string => "маленькая", neuter: (): string => "маленькое", _: (): string => "маленький" })(), few: (): string => selectBranch(String(__lgl_p2), { female: (): string => "маленькие", _: (): string => "маленьких" })(), _: (): string => "маленьких" })(), big: (): string => selectBranch(pluralRu(__lgl_p1), { one: (): string => selectBranch(String(__lgl_p2), { male: (): string => "большой", female: (): string => "большая", neuter: (): string => "большое", _: (): string => "большой" })(), few: (): string => selectBranch(String(__lgl_p2), { female: (): string => "большие", _: (): string => "больших" })(), _: (): string => "больших" })(), _: (): string => selectBranch(pluralRu(__lgl_p1), { one: (): string => selectBranch(String(__lgl_p2), { male: (): string => "обычный", female: (): string => "обычная", neuter: (): string => "обычное", _: (): string => "обычный" })(), few: (): string => selectBranch(String(__lgl_p2), { female: (): string => "обычные", _: (): string => "обычных" })(), _: (): string => "обычных" })() })();
}
...
function __lgl_name_6D61696E2E44656C697665726564(__lgl_p0: number | bigint | string, __lgl_p1: __lgl_name_6D61696E2E47656E646572): string {
  return selectBranch(pluralRu(__lgl_p0), { one: (): string => selectBranch(String(__lgl_p1), { male: (): string => "Доставлен", female: (): string => "Доставлена", neuter: (): string => "Доставлено", _: (): string => "Доставлено" })(), _: (): string => "Доставлено" })();
}

export const main = {
  codegen: {
    kicker: "Генерация кода",
    title: "Одна схема — типизированный вывод TypeScript",
  ...
  hero: {
    ...
    intro: "Linguini превращает locale-файлы, связанные со схемой, в типизированный сгенерированный код. До генерации check/build сообщают об отсутствующих реализациях и проверяют поддерживаемое использование форматтеров, а также вызовы и ветви dispatch, которые анализатор способен разрешить.",
  ...
  web: {
    ...
    intro: "Пишите обычные маршруты SvelteKit и вызывайте сгенерированные сообщения. Linguini хранит активную локаль и реактивно обновляет текст. Сигнатуры сгенерированных сообщений позволяют TypeScript сообщать о неверных аргументах при проверке типов приложения.",
