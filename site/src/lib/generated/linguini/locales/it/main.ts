...
function pluralIt(value: number | bigint | string): string {
...
function formatDate(
  ...
  switch (options.style ?? "medium") {
    case "full":
      return ["domenica", "lunedì", "martedì", "mercoledì", "giovedì", "venerdì", "sabato"][date.getUTCDay()] + " " + String(date.getUTCDate()) + " " + ["gennaio", "febbraio", "marzo", "aprile", "maggio", "giugno", "luglio", "agosto", "settembre", "ottobre", "novembre", "dicembre"][date.getUTCMonth()] + " " + String(date.getUTCFullYear());
    case "long":
      return String(date.getUTCDate()) + " " + ["gennaio", "febbraio", "marzo", "aprile", "maggio", "giugno", "luglio", "agosto", "settembre", "ottobre", "novembre", "dicembre"][date.getUTCMonth()] + " " + String(date.getUTCFullYear());
    case "short":
      return padNumber(date.getUTCDate(), 2) + "/" + padNumber(date.getUTCMonth() + 1, 2) + "/" + padNumber(date.getUTCFullYear() % 100, 2);
    default:
      return String(date.getUTCDate()) + " " + ["gen", "feb", "mar", "apr", "mag", "giu", "lug", "ago", "set", "ott", "nov", "dic"][date.getUTCMonth()] + " " + String(date.getUTCFullYear());
  }
}
...
const __lgl_form_6D61696E2E4672756974 = {
  apple: { Gender: "neuter", emoji: "🍎", nom: (value: number | bigint | string) => selectBranch(pluralIt(value), { one: "mela", _: "mele" }) },
  pear: { Gender: "female", emoji: "🍐", nom: (value: number | bigint | string) => selectBranch(pluralIt(value), { one: "pera", _: "pere" }) },
  orange: { Gender: "male", emoji: "🍊", nom: (value: number | bigint | string) => selectBranch(pluralIt(value), { one: "arancia", _: "arance" }) },
} as const;

function __lgl_name_6D61696E2E53697A65576F7264(__lgl_p0: __lgl_name_6D61696E2E53697A65): string {
  return selectBranch(String(__lgl_p0), { small: (): string => "piccolo", big: (): string => "grande" })();
}
...
function __lgl_name_6D61696E2E53697A6541646A(__lgl_p0: __lgl_name_6D61696E2E53697A65, __lgl_p1: number | bigint | string, __lgl_p2: __lgl_name_6D61696E2E47656E646572): string {
  return selectBranch(String(__lgl_p0), { small: (): string => selectBranch(pluralIt(__lgl_p1), { one: (): string => selectBranch(String(__lgl_p2), { male: (): string => "piccolo", female: (): string => "piccola", neuter: (): string => "piccolo", _: (): string => "piccolo" })(), _: (): string => selectBranch(String(__lgl_p2), { male: (): string => "piccoli", female: (): string => "piccole", neuter: (): string => "piccoli", _: (): string => "piccoli" })() })(), big: (): string => selectBranch(pluralIt(__lgl_p1), { one: (): string => selectBranch(String(__lgl_p2), { male: (): string => "grande", female: (): string => "grande", neuter: (): string => "grande", _: (): string => "grande" })(), _: (): string => selectBranch(String(__lgl_p2), { male: (): string => "grandi", female: (): string => "grandi", neuter: (): string => "grandi", _: (): string => "grandi" })() })(), _: (): string => "normali" })();
}
...
function __lgl_name_6D61696E2E44656C697665726564(__lgl_p0: number | bigint | string, __lgl_p1: __lgl_name_6D61696E2E47656E646572): string {
  return selectBranch(pluralIt(__lgl_p0), { one: (): string => selectBranch(String(__lgl_p1), { _: (): string => "Consegnato" })(), _: (): string => "Consegnati" })();
}

export const main = {
  codegen: {
    kicker: "Generazione codice",
    title: "Uno schema, output TypeScript tipizzato",
  ...
  hero: {
    ...
    intro: "Linguini trasforma file locale legati allo schema in codice generato tipizzato. Prima della generazione, check/build segnalano implementazioni mancanti e validano gli usi supportati dei formattatori, oltre alle chiamate locale e ai rami di dispatch che l'analizzatore riesce a risolvere.",
