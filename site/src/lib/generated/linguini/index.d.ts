...
export declare const locales: readonly ["en", "ru", "es", "fr", "de", "it", "zh", "pt", "pt-BR"];
...
export declare const localeModules: {
  ...
  readonly pt: typeof locale_pt;
  readonly "pt-BR": typeof locale___lgl_name_70742D4252;
};
...
export declare const localeLoaders: {
  ...
  readonly pt: () => Promise<typeof locale_pt>;
  readonly "pt-BR": () => Promise<typeof locale___lgl_name_70742D4252>;
};
